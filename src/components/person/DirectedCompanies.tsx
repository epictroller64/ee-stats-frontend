...
export default function DirectedCompanies({ directedCompanies }: { directedCompanies: CompanyDetails[] }) {
    if (directedCompanies.length === 0) {
        return (
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Directed Companies</h2>
                <p className="text-gray-500 text-center py-8">No companies directed by this person.</p>
            </div>
        );
    }
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Directed Companies</h2>
            <div className="grid gap-4">
                {directedCompanies.map((company) => (
                    <div
